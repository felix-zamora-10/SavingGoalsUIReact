...
import "./Styles/SavingGoalDetails.css";
import DetailsSG from "../Images/DetailsSG.png";

class SavingGoalDetails extends React.Component {
  applyCollapsible() {
  ...
  render() {
    return (
      <div className="information-panel">
        ...
        <div>
          <input id="btnExit" type="button" value="Salir" />
        </div>
      </div>
    );
  }
...
export default SavingGoalDetails;
